...
describe("custom responses", () => {
    ...
    describe("set", () => {
        it("should default body to OK", () => {
            ...
            expect(customResponses.get("incoming-webhooks", "set.walter.white")[1]).toEqual("OK");
        });
    });
    describe("get", () => {
        it("should get a default response", () => {
            expect(customResponses.get("incoming-webhooks", "get.walter.white")).toMatchObject([200, "OK", {}]);
        });
    });
    describe("reset", () => {
        it("should clear responses for a type", () => {
            ...
            expect(customResponses.get("incoming-webhooks", "reset.walter.white")[0]).toEqual(202);
        });
    });
    describe("resetAll", () => {
        it("should clear responses for all types", () => {
            ...
            customResponses.resetAll();
            expect(customResponses.get("incoming-webhooks", "reset.walter.white")[0]).toEqual(200);
        });
    });
});
